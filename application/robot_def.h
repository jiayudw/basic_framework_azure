...
// 云台参数
#define YAW_CHASSIS_ALIGN_ECD 3583 // 云台和底盘对齐指向相同方向时的电机编码器值,若对云台有机械改动需要修改 //原始脉冲 (292) - (YAW_CHASSIS_ALIGN_ECD * 360 / 8192) = 0 hero为2844
#define YAW_ECD_GREATER_THAN_4096 0 // ALIGN_ECD值是否大于4096,是为1,否为0;用于计算云台偏转角度
#define PITCH_HORIZON_ECD 3380      // 云台处于水平位置时编码器值,若对云台有机械改动需要修改
#define PITCH_MAX_ANGLE 35           // 云台竖直方向最大角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
#define PITCH_MIN_ANGLE -24           // 云台竖直方向最小角度 (注意反馈如果是陀螺仪，则填写陀螺仪的角度)
// 发射参数
#define ONE_BULLET_DELTA_ANGLE 60 * 14.5    // 发射一发弹丸拨盘转动的距离,由机械设计图纸给出 上交45 * 25    360/孔数×减速比   要巍峨
