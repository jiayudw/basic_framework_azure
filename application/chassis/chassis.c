...
void ChassisInit()
{
    ...
    referee_data = RefereeInit(&huart6); // 裁判系统初始化,会同时初始化UI
...
static void LimitChassisOutput()
{
    ...
    // // =========================================================
    // const float MAX_WHEEL_SPEED = 29000.0f; // M3508电机的最大安全设定转速(根据实际PID整定修改)
    ...
    if (referee_data != NULL)
{
    ...
    chassis_feedback_data.shoot_heat =
        (float)referee_data->PowerHeatData.shooter_17mm_barrel_heat;
